...
app = Flask(__name__)
##postgress
engine = create_engine("mysql+pymysql://root:sajjid@localhost:3306/feerecord")
...
def view():
    if request.method == "POST":
        ...
        subfee = request.form.get("sub_fee")
        duefee = request.form.get("due_fee")
        totfee = request.form.get("tot_fee")
        db.execute("INSERT into fee(firstname, lastname, Session, submitted_fee, due_fee, total_fee) VALUES (:firstname, :lastname, :Session, :submitted_fee, :due_fee, :total_fee)",
